...
def get_train_contiguous_id_to_test_thing_dataset_id_dict(
    ...
    if train_thing_dataset_id_to_contiguous_id == test_thing_dataset_id_to_contiguous_id:
        ...
        if 'coco_ood_val' == args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
        ...
        elif 'coco_2017_custom_val' == args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                        ChainMap(*[{i: i + 1} for i in range(20)]))
            ...
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
        elif 'balanced_openimages_ood' == args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
            ...
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(10)]))
        elif 'ImageNet1k_Val_OE_BDD100K_v2' ==args.test_dataset and 'bdd_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(10)]))
            ...
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
        elif 'openimages_v2_ood_val' ==args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
        elif 'openimages_cococat_ours_ood_val' ==args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
        elif 'balanced_coco_ood' ==args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
        elif 'balanced_coco_val_ood' ==args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
        elif 'balanced_coco_val_ood_v2' ==args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
        elif 'balanced_coco_val_ood_v3' ==args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                ChainMap(*[{i: i + 1} for i in range(20)]))
        elif 'strict_coco_ood_val' == args.test_dataset and 'voc_custom_train' == cfg.DATASETS.TRAIN[0]:
            from collections import ChainMap
            cat_mapping_dict = dict(
                        ChainMap(*[{i: i + 1} for i in range(20)]))
        else:
