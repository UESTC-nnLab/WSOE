...
parser.add_argument('--ood-dataset', default='coco_ood_val', type=str)
...
ood_data = pickle.load(open('detection/data/VOC-Detection/' + args.model + '/'+args.name+'/random_seed' +'_'+str(args.seed)  +'/inference/'+ args.ood_dataset + '/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))
